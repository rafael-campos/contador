...
export default function MemoriesPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen overflow-x-hidden">
      <Head>
        <title>Nossas Memórias | {wifeName} & {yourName}</title>
        <meta name="description" content={`Uma linha do tempo das nossas memórias mais queridas - ${wifeName} & {yourName}`} />
      ...
      <main className="flex-grow w-full">
        ...
        <section className="py-8 md:py-16 text-center">
            <div className="container mx-auto px-4">
                ...
                <BlurText
                  as="p"
                  text="Uma viagem através dos momentos que construíram a nossa história."
